        ...
        <form method="POST" action="{{ route('staff.add-category') }}">
            ...
            <div class="grid grid-cols-4">
                    ...
                    <div class="col-span-3 mb-4">
                        <input type="text" name="category_name" id="category_name" class="form-input py-3 px-3 pr-11 block w-full border-gray-200 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500">
                    </div>
                    ...
                    <div class="col-span-3 mb-4 mt-1">
                        <input type="text" name="category_description" id="category_description" class="form-input py-3 px-3 pr-11 block w-full border-gray-200 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500">
                    </div>
