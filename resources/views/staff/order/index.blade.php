...
<section>
    <div class="max-w-4xl mx-auto p-2">
        ...
        <h2 class="text-2xl font-extrabold mb-4 py-8">Active User</h2>
        ...
        <h2 class="text-2xl font-extrabold mb-4 py-8">Active Staff</h2>
        ...
        <div class="mb-8 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
            <a href="{{ route('admin.create-account') }}" class="flex items-center justify-center bg-green-500 text-white rounded-lg p-4">
