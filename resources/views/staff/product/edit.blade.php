            ...
            <div class="border border-gray-200 shadow-lg rounded-xl py-2 px-4">
                <form method="POST" action="{{ route('staff.products.update', $product->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-3">
                        ...
                        <div class="col-span-1">
                            <label for="product_minimum_quantity" class="text-sm text-gray-800 mt-4">Minimum
                                Quantity</label>
                        </div>
                        <div class="col-span-2 my-2">
                        ...
                        <div class="col-span-2 my-2">
                            <select name="product_status" id="product_status"
                                ...
                                <option value="unavailable"
                                    {{ $product->product_status == 'unavailable' ? 'selected' : '' }}>Unavailable
                                </option>
                            </select>
                        ...
                        <div class="col-span-2 my-2">
                            ...
                            <input type="file" name="images[]" id="images"
                                class="form-input block w-full border border-gray-300 shadow-sm rounded-md text-sm focus:z-10 focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 file:bg-transparent"
                                multiple>
                            @error('images')
                                <div class="text-sm text-red-600">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-span-3 my-2">
                            <button type="submit"
                                class="py-2 px-4 w-full inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-blue-500 text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm">
                                Update Product
                            </button>
                        </div>
                    </div>
