            ...
            <div class="rounded-xl border border-gray-50 py-2 px-4 shadow-md">
                <div class="flex flex-row border-b-2">
                    <nav class="flex space-x-6">
                        <a class="hs-tab-active:font-semibold hs-tab-active:border-blue-600 hs-tab-active:text-blue-600 py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-black hover:text-blue-600 active"
                            href="{{ route('order.history') }}" aria-current="page">
                            All
                        </a>
                        <a class="hs-tab-active:font-semibold hs-tab-active:border-blue-600 hs-tab-active:text-blue-600 py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-black hover:text-blue-600"
                            href="{{ route('order.pending') }}" aria-current="page">
                            Pending
                        </a>
                        <a class="hs-tab-active:font-semibold hs-tab-active:border-blue-600 hs-tab-active:text-blue-600 py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-black hover:text-blue-600"
                            href="{{ route('order.confirmed') }}" aria-current="page">
                            Confirmed
                        </a>
                        <a class="hs-tab-active:font-semibold hs-tab-active:border-blue-600 hs-tab-active:text-blue-600 py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-black hover:text-blue-600"
                            href="{{ route('order.processing') }}" aria-current="page">
                            Processing
                        </a>
                        <a class="hs-tab-active:font-semibold hs-tab-active:border-blue-600 hs-tab-active:text-blue-600 py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-black hover:text-blue-600"
                            href="{{ route('order.completed') }}" aria-current="page">
                            Completed
                        </a>
                    </nav>
                </div>
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col"
                                                ...
                                                Status</th>
                                            <th scope="col"
                                                class="px-6 py-3 text-right text-xs font-semibold text-gray-500 uppercase">
                                                Total</th>
                                        </tr>
                                    </thead>
                                            ...
                                            @foreach ($orders as $order)
                                                <tr>
                                                    <td
                                                        ...
                                                        <a class="block"
                                                            href="{{ route('staff.show-each-order', ['id' => $order->id]) }}">
                                                            {{ $order->order_name }}
                                                        </a>
                                                    </td>
                                                    <td
                                                        class="px-6 py-4 whitespace-nowrap text-sm text-left text-gray-800 dark:text-gray-200">
                                                        <a class="block"
                                                            href="{{ route('staff.show-each-order', ['id' => $order->id]) }}">
                                                            {{ $order->order_status }}
                                                        </a>
                            ...
                            @if ($orders->count() <= 0)
                                <div class="max-w-5xl mx-auto p-2 min-h-[15rem] flex flex-col bg-white">
                                    <div class="flex flex-auto flex-col justify-center items-center p-4 md:p-5">
                                        <svg class="max-w-[5rem]" viewBox="0 0 375 428" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path d="M254.509 253.872L226.509 226.872"
                                                class="stroke-gray-400 dark:stroke-white" stroke="currentColor"
                                            ...
                                            <rect x="270.524" y="221.872" width="137.404" height="73.2425" rx="36.6212"
                                                ...
                                                class="fill-gray-400 dark:fill-white" fill="currentColor" />
                                            <ellipse cx="133.109" cy="404.372" rx="121.5" ry="23.5"
                                                class="fill-gray-400 dark:fill-white" fill="currentColor" />
                                            <path d="M111.608 188.872C120.959 177.043 141.18 171.616 156.608 188.872"
                                                class="stroke-gray-400 dark:stroke-white" stroke="currentColor"
                                                stroke-width="7" stroke-linecap="round" />
                                            <ellipse cx="96.6084" cy="116.872" rx="9" ry="12"
                                                class="fill-gray-400 dark:fill-white" fill="currentColor" />
                                            <ellipse cx="172.608" cy="117.872" rx="9" ry="12"
                                                class="fill-gray-400 dark:fill-white" fill="currentColor" />
                                            <path
